...
import 'package:sandwich_shop/services/firebase_order_service.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> _processPayment() async {
    ...
    try {
      ...
      // CRITICAL: Save to local database FIRST and WAIT for it
      debugPrint('=== CHECKOUT: About to save order to database ===');
      final DatabaseService databaseService = DatabaseService();
      await databaseService.insertOrder(savedOrder);
      debugPrint('=== CHECKOUT: Order saved to database successfully ===');

      // Save to Firebase (optional, don't block on failure)
      try {
        final FirebaseOrderService firebaseService = FirebaseOrderService();
        await firebaseService.saveOrder(cart, orderId);
        debugPrint('=== CHECKOUT: Order saved to Firebase ===');
      } catch (e) {
      ...
      debugPrint('=== CHECKOUT: Payment processing error: $e ===');
      if (mounted) {
        setState(() {
          _isProcessing = false;
        });
